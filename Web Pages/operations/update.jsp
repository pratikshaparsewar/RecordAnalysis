    ...
    <body>
        <div class="container">
            <div class="col-md-12 operations">
                <a class="btn btn-primary">Add a new employee</a>
                <a class="btn btn-primary">Delete the employee</a>
                <a class="btn btn-primary">Update data</a>
                <a class="btn btn-primary">List all employees</a>
            </div>
        </div>
